 ...
 * scaled for reach both of maximums. You can preserve ratio or not with [preserveRatio]
 ...
 * @param chooserTitle lets you customize "photo camera" item title in app chooser
 */
