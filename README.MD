...
RxJava 1 
```groovy      
implementation "iam.thevoid.mediapicker:rx1:1.0.0-rc05"
 ```
 RxJava 2 
 ```groovy      
implementation "iam.thevoid.mediapicker:rx2:1.0.0-rc05"
 ```
 RxJava 3 
 ```groovy      
implementation "iam.thevoid.mediapicker:rx3:1.0.0-rc05"
 ```
